...
顺便向大家推荐一个对日语语法学习很有帮助的网站 - [日语语法指南](http://res.wokanxing.info/jpgramma/index.html)，他是翻译自[Tae Kim 所写的《Japanese Grammar Guide》](http://www.guidetojapanese.org/learn/grammar)，那个网址有点长我就简单的镜像了一下 -> [ja.dacer.im](http://ja.dacer.im)，总之如果是初学者的话，看了就能知道真的非常的好。
